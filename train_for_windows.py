...
if __name__ == "__main__":
    ...
    #training_path = os.path.join(base_path,r"/data/training/training-set")
    #validation_path = os.path.join(base_path,r"/data/validation/validation-set")
    training_path = input('where is the training set ')
    validation_path = input('where is the validation set ')
    ...
    now = datetime.now()
    logdir = os.path.join(base_path,"data","tf-logs",now.strftime("%B_%d_%Y_%I_%M%p"))
